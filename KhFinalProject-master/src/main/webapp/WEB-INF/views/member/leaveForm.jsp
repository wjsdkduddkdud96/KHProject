...
<div class="login">
	<h1>회원 탈퇴</h1>
    	<input type="text" id="userId" name="userId" value="${sessionScope.loginId}" readonly/> <!-- required="required" -->
        ...
        <input id="leaveId" type="button" value="탈퇴" class="btn btn-primary btn-block btn-large">
</div>
</form>
